...
public class EventRegistrationServiceImpl implements EventRegistrationService {
	...
	public EventRegistaration calculateEventRegistrationAmount(EventRegistaration eventRegistaration, Event event) {
		try {
			Period period = Period.between(event.getRegistrationClose(),
					eventRegistaration.getRegistrationDate().toLocalDate());
